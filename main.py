...
heart_disease_model_path = r'C:\Users\admin\Desktop\MULTIPLEDISEASEPREDICTION\sav\heartdisease.sav'
lung_disease_model_path = r'C:\Users\admin\Desktop\MULTIPLEDISEASEPREDICTION\sav\lungdisease.sav'
diabetes_model_path = r'C:\Users\admin\Desktop\MULTIPLEDISEASEPREDICTION\sav\diabetes.sav'
# Verify file paths
print("Heart Disease Model Path:", heart_disease_model_path)
print("Lung Cancer Model Path:", lung_disease_model_path)
print("Diabetes Model Path:", diabetes_model_path)

# Load models
heart_disease_model = pickle.load(open(heart_disease_model_path, 'rb'))
lung_cancer_model = pickle.load(open(lung_disease_model_path, 'rb'))
